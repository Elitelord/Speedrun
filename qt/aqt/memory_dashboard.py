...
"""Speedrun: a window hosting the honest MCAT memory-score dashboard.

The dashboard itself is the Svelte page at ts/routes/memory-dashboard; this is
just a thin Qt shell that loads it in a webview.
"""
...
class MemoryDashboardDialog(QDialog):
    ...
    def __init__(self, mw: aqt.main.AnkiQt) -> None:
        ...
        self.setWindowTitle("MCAT Memory")
